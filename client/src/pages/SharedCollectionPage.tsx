...
import { CreateLinkBar, CreateLinkForm } from "@/components/Forms";
      ...
      if (location.includes("/c")) {
        try {
          ...
          if (!currentCollection) {
            ...
            const shared = new URLSearchParams(window.location.search).toString() || null;
            ...
            const doesUserHaveAccess: boolean =
            ...
            setDoesUserHaveAccess(doesUserHaveAccess)
